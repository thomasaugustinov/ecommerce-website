...
export default function Nav({show}) {
    const inactiveLink = 'flex gap-1 p-1 text-gray-300';
    const activeLink = 'flex gap-1 p-1 bg-highlighted text-white rounded-md';
    ...
    return(
        <aside className={(show ? 'left-0' : '-left-full') + " top-0 text-gray-300 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}>
